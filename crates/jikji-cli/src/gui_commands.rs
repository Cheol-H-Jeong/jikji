...
<body>
  ...
  (() => {
    ...
    const state = { root: "", folder: "", selected: "", selectedPaths: new Set(), query: "", roots: [], confirmAction: null, request: {} };
